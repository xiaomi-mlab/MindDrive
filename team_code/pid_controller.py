...
class PIDController(object):
    ...
    def __init__(self, turn_KP=1.1, turn_KI=0.5, turn_KD=1.0, turn_n=40, speed_KP=5.0, speed_KI=0.5,speed_KD=1.0, speed_n = 40,max_throttle=0.75, brake_speed=0.1,brake_ratio=1.1, clip_delta=0.25, aim_dist=3.0, angle_thresh=0.3, dist_thresh=10):
