...
SUSPEND_EVENT = {
    ...
    TrafficEventType.COLLISION_PEDESTRIAN: -1,
    TrafficEventType.COLLISION_VEHICLE: -1,
    TrafficEventType.COLLISION_STATIC: -1,
    TrafficEventType.TRAFFIC_LIGHT_INFRACTION: -1,
    TrafficEventType.STOP_INFRACTION: -1,
    TrafficEventType.ROUTE_DEVIATION:-1,
...
PENALTY_VALUE_DICT = {
    ...
    TrafficEventType.OUTSIDE_ROUTE_LANES_INFRACTION:0.7,
}
PENALTY_PERC_DICT = {
