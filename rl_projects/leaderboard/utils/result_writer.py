...
class ResultOutputProvider(object):
    ...
    def __init__(self, data):
        ...
        for criterion in self._data.route_scenario.get_criteria():
            if criterion.test_status != "SUCCESS":
                self._global_result = '\033[91m'+'FAILURE'+'\033[0m'
        if self._data.route_scenario.timeout_node.timeout:
            self._global_result = '\033[91m'+'FAILURE'+'\033[0m'
    ...
    def create_output_text(self):
        ...
        output += "\033[1m========= Results of {} (repetition {}) ------ {} \033[1m=========\033[0m\n".format(
            self._data.manager.scenario_tree.name, self._data.manager.repetition_number, self._global_result)
        output += "\n"
        ...
        if self._data.scenario_duration_game < self._data.route_scenario.timeout:
