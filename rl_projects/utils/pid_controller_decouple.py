...
class PIDController(object):
    def __init__(self, turn_KP=1.0, turn_KI=0.4, turn_KD=0.4, turn_n=40, speed_KP=6.0, speed_KI=0.5, speed_KD=1.0, speed_n=40,
                 max_throttle=0.75, brake_speed=0.1, brake_ratio=1.1, clip_delta=0.25, aim_dist=4.0, angle_thresh=0.3, dist_thresh=10,
                 lookahead_scale=0.8, lookahead_offset=0, lookahead_min=1, lookahead_max=20):
        ...
        self.lookahead_scale = lookahead_scale 
