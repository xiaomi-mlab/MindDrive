...
num_epochs = 6
llm_path = 'ckpts/llava-qwen2-0.5b'
use_gen_token = False
use_col_loss = False
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs','input_ids','gt_attr_labels', 'ego_fut_trajs', 'ego_fut_masks','ego_fut_cmd', 'ego_lcf_feat','vlm_labels','can_bus', 'traffic_state_mask', 'traffic_state','vlm_attn_mask']+collect_keys),
]
...
load_from='ckpts/llava-qwen2-0.5b-eva02_petr_proj.pth'
resume_from=None