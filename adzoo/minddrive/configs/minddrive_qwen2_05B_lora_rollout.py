...
dataset_type_rollout = "B2D_minddrive_Dataset"
...
train_pipeline = [
    ...
    dict(type='LoadAnnoatationHistoryVQA', 
        ...
        #  base_conv_path='./data/train_desc',
...
workflow = [('rollout', 1)]
runner = dict(
    type='RLIterBasedRunner', max_iters=1, il_step=20, n_steps=6000)
...
load_from = 'work_dirs/minddrive_qwen2_05b_train_stage3/iter_11004_Minddrive.pth'