...
num_epochs = 6
llm_path = 'ckpts/llava-qwen2.5-3b'
use_gen_token = True
use_col_loss = True
    ...
    dict(
        ...
        transforms=[
            dict(
                ...
                with_label=False),
            dict(type='CustomCollect3D',\
                keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs','input_ids','gt_attr_labels', 'ego_fut_trajs', 'ego_fut_masks','ego_fut_cmd', 'ego_lcf_feat','vlm_labels','can_bus','fut_valid_flag','path_points_future']+collect_keys,
                )]
    )
]
...
load_from='work_dirs/minddrive_qwen25_3B_train_stage2/iter_11004.pth'
resume_from=None