...
class MinddriveHeadM(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is MinddriveHeadM):
        ...
        super(MinddriveHeadM, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is MinddriveHeadM:
            convert_dict = {
    ...
    def forward(self, img_metas, pos_embed, **data):
        ...
        outs = {
            ...
            'outs_dec':outs_dec # 250519:@fuhaoyu,传递map特征给预测车道线
        }
        if self.output_dims is not None:
