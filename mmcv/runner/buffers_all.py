...
class RolloutBuffer(BaseBuffer):
    ...
    def reset(self) -> None:
        ...
        self.ref_log_probs = np.zeros((self.buffer_size, self.n_envs, 1), dtype=np.float32)
    ...
    def get(self, batch_size: Optional[int] = None) -> Generator[RolloutBufferSamples, None, None]:
        ...
        if not self.generator_ready:
            ...
            for tensor in _tensor_names:
                if tensor in ["action_language_log_probs","value_language_log_probs"]:
    ...
    def _get_samples(
        ...
        data = (
            ...
            self.ref_log_probs[batch_inds].flatten(),
